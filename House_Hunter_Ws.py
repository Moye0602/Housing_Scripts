...
#area='_DC_Area2'
origin_source='hhttps://www.redfin.com/zipcode/30909/filter/property-type=house+townhouse+multifamily+co-op,max-price=400k,min-beds=2,min-baths=1.5,hoa=100'
area='GA_Augusta'
